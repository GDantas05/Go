...
func main() {
	entrada := os.Args[1:]
	//O COMANDO MAKE CRIA UM SLICE E OS DOIS PARÂMETROS INFORMAN O TIPO(INT) E QUAL VAI SER O TAMANHO
	//MÁXIMO DO SLICE(NESSA CASO O TAMANHO SERÁ A QUANTIDADE DE ELEMENTOS)
